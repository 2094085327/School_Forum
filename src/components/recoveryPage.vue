<template>
  <body id="poster" v-if="this.$store.state.replyType==='主题'">
  <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm"
    ...
    <el-form-item label="文章内容:" prop="userName" style="margin: 0">
  ...
  <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm"
    ...
    <el-form-item label="内容:" prop="userName" style="margin: 0">
      <h4 style="margin-top: 0;text-align: left;">{{ this.$store.state.topicContent }}</h4>
    </el-form-item>
    <el-form-item label="操作员:" prop="pass" style="margin: 0">
      <h4 style="margin-top: 0;text-align: left;">{{ this.$store.state.name }}</h4>
  ...
  methods: {
    ...
    submitForm(formName) {
      if (this.$store.state.replyType === '主题') {
        ...
        console.log("this.$store.state.replyId")
        console.log(this.$store.state.replyId)
